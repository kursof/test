...

{
	...
	std::cout << "skolko stoyat konfety?: ";
	std::cin >> a; std::cout << "\n";

	std::cout << "skolko kilogramov irisok vy kupili?: ";
	std::cin >> y; std::cout << "\n";

	std::cout << "skolko stoyat iriski?: ";
	std::cin >> b; std::cout << "\n";

	std::cout << "1 kilogram konfet stoit: " << a/x << " rubley\n";
	std::cout << "1 kilogram irisok stoit: " << b/y << " rubley\n";
