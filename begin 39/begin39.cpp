...

{
	...
	if (a == 0) std::cout << "a cannot be a zero\n ";
	else
		if (d < 0) std::cout << "the equation has no roots\n";
		else
			if (x1 > x2) std::cout << "first root of the equation is: " << x2
			<< "\n" << "second root of the equation is: " << x1;
			else
				if (x1 < x2) std::cout << "first root of the equation is: "
				<< x1 << "\n" << "second root of the equation is: " << x2;
			else std::cout << "the equation has one root: " << x2;
