...

{
	...
	std::cout << "ukazhite skorost techeniya: ";
	std::cin >> u; std::cout << "\n";

	std::cout << "skolko vremeni lodka plyla po ozeru?: ";
	std::cin >> t1; std::cout << "\n";

	std::cout << "skolko vremeni lodka plula protiv techeniya reki?: ";
	std::cin >> t2; std::cout << "\n";

	std::cout << "lodka proshla: " << v * t1 + (v - u) * t2 << "\n";
